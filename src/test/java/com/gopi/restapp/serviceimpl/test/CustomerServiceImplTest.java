...
class CustomerServiceImplTest {
	...
	void testAddCustomer() {
		...
		assertEquals("Successfully Added",customerServiceImpl.addCustomer(customer));
	}
...
//		assertNotNull(customerServiceImpl.getCustomer(12));
//	}
...
//	}
	...
	void testUpdateCustomer() {
		...
		assertEquals("Successfully Updated",customerServiceImpl.updateCustomer(customer));
	}
...
//		assertEquals("Successfully Deleted",customerServiceImpl.deleteCustomer(23));
//	}

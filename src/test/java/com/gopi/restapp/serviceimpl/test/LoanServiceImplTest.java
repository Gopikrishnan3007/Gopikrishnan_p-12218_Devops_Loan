...
class LoanServiceImplTest {
	...
	void testAddLoan() {
		...
		assertEquals("Success to Add", loanServiceImpl.addLoan(loan));
	}
...
//		assertNull(loanServiceImpl.getLoan(1100));
//	}
	...
	void testUpdateLoan() {
		...
		assertEquals("Success to Update", loanServiceImpl.updateLoan(loan));
	}
...
//	@Test
//	void testDeleteLoan() {
//		assertEquals("Success to Delete",loanServiceImpl.deleteLoan(33));
//	}
